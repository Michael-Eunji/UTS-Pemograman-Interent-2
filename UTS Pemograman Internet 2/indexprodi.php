...
<html lang="en">
<head>
<title>Data Prodi Mahasiswa</title>
</head>
<body>
...
<h1>Data Prodi Mahasiswa</h1>
<a href="createprodi.php">Tambah Data</a>
<br>
<a href="printprodi.php" target="_blank">Cetak Data</a>
<br><br>
<table border="1">
<thead>
<tr>
...
<td>
<a name="edit" id="edit"
href="editprodi.php?ID_Absen=<?=$data->kodeprodi ?>">Edit</a>
<a name="hapus" id="hapus"
href="prosesprodi.php?ID_Absen=<?=$data->kodeprodi ?>">Delete</a>
</td>
</tr>
<?php endforeach;
} else{ ?>
<tr>
<td colspan="9">Belum ada data pada tabel prodi mahasiswa.</td>
</tr>
<?php } ?>
</tbody>
</table>
