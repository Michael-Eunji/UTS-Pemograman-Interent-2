...
<h1>Data Matkul</h1>
<a href="creatematkul.php">Tambah Data</a>
<br>
<a href="printmatkul.php" target="_blank">Cetak Data</a>
<br><br>
<table border="1">
<thead>
<tr>
...
<td>
<a name="edit" id="edit"
href="editmatkul.php?ID_Absen=<?=$data->kodemk ?>">Edit</a>
<a name="hapus" id="hapus"
href="prosesmatkul.php?ID_Absen=<?=$data->kodemk ?>">Delete</a>
</td>
</tr>
<?php endforeach;
} else{ ?>
<tr>
<td colspan="9">Belum ada data pada tabel matkul.</td>
</tr>
<?php } ?>
</tbody>
</table>
